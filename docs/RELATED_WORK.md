...
This note situates **Detecting Collusion Between Cooperating Agents** against the mentor-linked literature for
[Detecting Collusion Between Cooperating Agents](https://github.com/alanasung/multiagent-collusion).

## Positioning

Build monitors for covert coordination in small multi-agent LLM setups.

The design hypothesis is: Build monitors for covert coordination in small multi-agent LLM setups.
