...
from collude.configs.loader import register_schema
...
def _load_stage_registry(package: str = "collude") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in collude.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from collude.configs.loader import config_to_dict, save_resolved_config
    from collude.models.device import get_device
    from collude.utils.logging import configure_logging
    from collude.utils.reproducibility import set_seed
    from collude.utils.run_manifest import create_run_dir, save_run_metadata
